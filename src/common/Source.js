...
function parseUrl(url) {
  if (url.includes("github.com")) {
    ...
    var length = Rebase.$$Array[/* length */12](segments);
    if (length < 2) {
      Pervasives.failwith("What the hell kind of a URL is this: " + url);
    }
    return /* Github */[
            Rebase.$$Array[/* getOrRaise */15](length - 2 | 0, segments),
            Rebase.$$Array[/* getOrRaise */15](length - 1 | 0, segments)
          ];
  } else {
...
function looksLikeGitHubPath(str) {
  return +(Rebase.$$Array[/* length */12](str.split("/")) === 2);
}
