...
function make$5(method_, $staropt$star, $staropt$star$1, body, url) {
...
function get$2(url) {
  return fetch$1(make$5(/* GET */3546230, /* None */0, /* None */0, /* None */0, url));
}
...
function getStats(source) {
  ...
  return Future[/* map */8]((function (param) {
                return field("stargazers_count", $$int$2, param);
...
function collection(decoder) {
  ...
  return (function (param) {
      return map$10(partial_arg$3, partial_arg$1, param);
    });
}
...
function fromJson$1(key, json) {
  return /* record */[
          ...
          /* repository */field("repository", (function (param) {
                  return map$10(parse$1, string$1, param);
                }), json),
          ...
          /* comment */optional((function (param) {
                  return field("comment", string$1, param);
                }), json)
        ];
}
  ...
  return obj((function (param) {
                ...
                return /* record */[
                        ...
                        /* license */_orElse((function () {
                                return _2(field$$1[/* optional */0], "license", string$1);
                              }), _2(at$$1[/* optional */0], /* :: */[
                                  "license",
                                  /* :: */[
                                    "type",
                        ...
                        /* repositoryUrl */_orElse((function () {
                                return _2(field$$1[/* optional */0], "repository", string$1);
                              }), _2(at$$1[/* optional */0], /* :: */[
                                  "repository",
                                  /* :: */[
                                    "url",
                        ...
                        /* bugsUrl */_orElse((function () {
                                return _2(field$$1[/* optional */0], "bugs", string$1);
                              }), _2(at$$1[/* optional */0], /* :: */[
                                  "bugs",
                                  /* :: */[
                                    "url",
...
function get$4(repo) {
  ...
  return Future[/* map */8](fromJson$2, Future[/* flatMap */9]((function (param) {
                    if (param.tag) {
...
List[/* forEach */8]((function (source) {
        ...
        return Future[/* whenCompleted */6]((function (param) {
                      if (param.tag) {
                        console.log("\n", repo, "\n", param[0]);
                        return /* () */0;
                      } else {
                    ...
                    }), Future$1[/* >>= */0](get$4(repo), (function (manifest) {
                          return Future$1[/* >>= */0](getReadme(repo), (function (readme) {
                                        return Future$1[/* >>= */0](getStats(repo), (function (stats) {
                                                      var json = stringify(fromUnpublished(source, manifest, readme, stats));
                                                      var path = Path.join(packageDir, "unpublished", encodeURIComponent(makeId(repo)) + ".json");
                                                      return _1(Future$1[/* return */1], Fs$1[/* writeFile */2](path, json));
                                                    }));
                                      }));
                        })));
      }), Unpublished[/* get */1](/* None */0, /* () */0));
/*  Not a pure module */
