...
function get$4($staropt$star, _) {
  var filename = $staropt$star ? $staropt$star[0] : sourcesFile;
  return field("published", collection(fromJson$1), parseOrRaise(Fs.readFileSync(filename, "ascii")));
}
...
List[/* forEach */8]((function (source) {
        return Future[/* whenCompleted */6]((function (param) {
                      if (param.tag) {
                        ...
                        var data = param[0];
                        var json = stringify(fromPublished(source, data));
                        var path = Path.join(packageDir, encodeURIComponent(data[/* name */1]) + ".json");
                        return Fs$1[/* writeFile */2](path, json);
                      }
                    }), get$3(source[/* id */0]));
      }), Published[/* get */1](/* None */0, /* () */0));
