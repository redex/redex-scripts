...
function find$6(h, key) {
  var match = caml_array_get(h[/* data */1], key_index(h, key));
  if (match) {
    if (caml_compare(key, match[0])) {
      var rest1 = match[2];
      if (rest1) {
        if (caml_compare(key, rest1[0])) {
          var rest2 = rest1[2];
          if (rest2) {
            if (caml_compare(key, rest2[0])) {
              var key$1 = key;
              var _param = rest2[2];
              while(true) {
                var param = _param;
                if (param) {
                  if (caml_compare(key$1, param[0])) {
                    _param = param[2];
                    continue ;
...
function fold(f, h, init$$1) {
  var do_bucket = function (_b, _accu) {
    while(true) {
      var accu = _accu;
      var b = _b;
      if (b) {
        _accu = _3(f, b[0], b[1], accu);
        _b = b[2];
        continue ;
  ...
  for(var i = 0 ,i_finish = d.length - 1 | 0; i <= i_finish; ++i){
    accu = do_bucket(caml_array_get(d, i), accu);
  }
  return accu;
}
...
function list$1(encode, l) {
  return of_list(map$2(encode, l));
}


/* Js_dict Not a pure module */

var outputFile = Path.join(outputDir, "keywords.json");

function getKeywords(json) {
  return /* tuple */[
          field("id", string$1, json),
          field("keywords", (function (param) {
...
function makeInvertedIndex(data) {
  var index = create$2(/* None */0, $$Array[/* length */16](data));
  $$Array[/* forEach */8]((function (param) {
          var id = param[0];
          return $$Array[/* forEach */8]((function (keyword) {
                        var old;
                        try {
                          old = find$6(index, keyword);
                        }
                        catch (exn){
                          if (exn === not_found) {
                            old = /* [] */0;
                        ...
                        return replace(index, keyword, /* :: */[
                                    id,
                                    old
                                  ]);
                      }), param[1]);
        }), data);
  return fold((function (k, v, acc) {
                return /* :: */[
                        /* tuple */[
                          k,
                          v
...
var json = stringify(list$1((function (prim) {
            return prim;
                ...
                return fromList$2(/* :: */[
                            ...
                            /* :: */[
                              /* tuple */[
                                "count",
                                List[/* length */19](packages)
                              ],
                              /* :: */[
                                /* tuple */[
                                  "packages",
                                  list$1((function (prim) {
                                          return prim;
                                        }), packages)
                                ],
                                /* [] */0
              ...
              }), makeInvertedIndex($$Array[/* map */0](getKeywords, $$Array[/* map */0](parseOrRaise, $$Array[/* map */0]((function (path) {
                                return Fs.readFileSync(path, "utf8");
                              }), $$Array[/* filter */10]((function (path) {
                                    return $$String[/* endsWith */4](".json", path);
                                  }), Fs$1[/* readDirRecursively */0](packageDir)))))))));

Fs$1[/* writeFile */2](outputFile, json);
